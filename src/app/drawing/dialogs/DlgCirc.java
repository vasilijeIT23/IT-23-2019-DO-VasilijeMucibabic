...
public class DlgCirc {
    public static CircleParams ask(Window owner) {
        ...
        while (true) {
            ...
            try {
                ...
                return new CircleParams(radius, btnBorderColor.getColor(), btnInnerColor.getColor());
            } catch (NumberFormatException ex) {
                JOptionPane.showMessageDialog(
                        owner, "Radius must be positive integer.", "Validation",
    ...
    public record CircleParams(int radius, Color borderColor, Color innerColor) {}
}
